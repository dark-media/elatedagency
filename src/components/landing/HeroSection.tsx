...
export default function HeroSection() {
  ...
  return (
    ...
    >
      ...
      <button
        onClick={toggleMute}
        className="absolute bottom-24 right-6 z-20 flex h-10 w-10 items-center justify-center rounded-full border border-white/20 bg-dark-950/50 text-white/80 backdrop-blur-sm transition-all hover:border-gold-500/40 hover:bg-dark-950/70 hover:text-white sm:bottom-28 sm:right-8"
